...
public abstract class QuantileStatisticIntegers {
     ...
     * @return                   map of wells and results   
     */
    public Map<Well, Double> plate(Plate plate, int begin, int length, double p) {
     ...
     */
    public double platesAggregated(Plate plate, double p) {
     ...
     */
    public Map<Plate, Double> platesAggregated(Collection<Plate> collection, double p) {
     ...
     */
    public Map<Plate, Double> platesAggregated(Plate[] array, double p) {
    ...
    public double platesAggregated(
            Plate plate, int begin, int length, double p) {
    ...
    public Map<Plate, Double> platesAggregated(
            Collection<Plate> collection, int begin, int length, double p) {
     ...
     */
    public Map<Plate, Double> platesAggregated(
            Plate[] array, int begin, int length, double p) {
     ...
     * @return                     map of wells and results
     */
    public Map<Well, Double> set(WellSet set, double p) {
     ...
     * @return                     map of wells and results
     */
    public Map<Well, Double> set(WellSet set, int begin, int length, double p) {
     ...
     * @return                     the aggregated result
     */
    public double setsAggregated(WellSet set, double p) {
     ...
     */
    public Map<WellSet, Double> setsAggregated(Collection<WellSet> collection, double p) {
     ...
     * @return                       map of well sets and aggregated results
     */
    public Map<WellSet, Double> setsAggregated(WellSet[] array, double p) {
    ...
    public double setsAggregated(
            WellSet set, int begin, int length, double p) {
    ...
    public Map<WellSet, Double> setsAggregated(
            Collection<WellSet> collection, int begin, int length, double p) {
     ...
     */
    public Map<WellSet, Double> setsAggregated(
            WellSet[] array, int begin, int length, double p) {
     ...
     * @return                  the result
     */
    public double well(Well well, double p) {
     ...
     * @return                  the result
     */
    public double well(Well well, int begin, int length, double p) {
        Preconditions.checkNotNull(well, "The well cannot be null.");
