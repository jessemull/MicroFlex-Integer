...
public abstract class DescriptiveStatisticListWeights extends DescriptiveStatisticList {
     ...
     */
    public Map<Well, List<Double>> plate(Plate plate, double[] weights) {
     ...
     * @return                   map of wells and results
     */
    public Map<Well, List<Double>> plate(Plate plate, double[] weights, int begin, int length) {
     ...
     */
    public List<Double> platesAggregated(Plate plate, double[] weights) {
     ...
     * @return                   the aggregated result
     */
    public List<Double> platesAggregated(Plate plate, double[] weights, int begin, int length) {
     ...
     * @return                     map of wells and results
     */
    public Map<Well, List<Double>> set(WellSet set, double[] weights) {
     ...
     * @return                     map of wells and results
     */
    public Map<Well, List<Double>> set(WellSet set, double[] weights, int begin, int length) {
     ...
     */
    public List<Double> setsAggregated(WellSet set, double[] weights) {
     ...
     * @return                     the aggregated result
     */
    public List<Double> setsAggregated(WellSet set, double[] weights, int begin, int length) {
     ...
     * @return                  the result
     */
    public List<Double> well(Well well, double[] weights) {
     ...
     * @return                  the result
     */
    public List<Double> well(Well well, double[] weights, int begin, int length) {
