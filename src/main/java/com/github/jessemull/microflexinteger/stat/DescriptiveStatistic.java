...
public abstract class DescriptiveStatistic {
     ...
     * @return                   map of wells and results   
     */
    public Map<Well, Double> plate(Plate plate, int begin, int length) {
     ...
     */
    public double platesAggregated(Plate plate) {
     ...
     */
    public Map<Plate, Double> platesAggregated(Collection<Plate> collection) {
     ...
     */
    public Map<Plate, Double> platesAggregated(Plate[] array) {
     ...
     * @return                     map of wells and results
     */
    public Map<Well, Double> set(WellSet set) {
     ...
     * @return                     map of wells and results
     */
    public Map<Well, Double> set(WellSet set, int begin, int length) {
     ...
     * @return                     the aggregated result
     */
    public double setsAggregated(WellSet set) {
     ...
     */ 
    public Map<WellSet, Double> setsAggregated(Collection<WellSet> collection) {
     ...
     * @return                       map of well sets and aggregated results
     */
    public Map<WellSet, Double> setsAggregated(WellSet[] array) {
     ...
     * @return                  the result
     */
    public double well(Well well, int begin, int length) {
        Preconditions.checkNotNull(well, "The well cannot be null.");
