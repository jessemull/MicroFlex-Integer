...
public abstract class QuantileStatisticListsIntegers {
     ...
     * @return                    map of wells and results   
     */
    public Map<Well, List<List<Double>>> plate(Plate plate, int begin, int length, List<Double> list) {
     ...
     */
    public List<List<Double>> platesAggregated(Plate plate, List<Double> list) {
     ...
     */
    public Map<Plate, List<List<Double>>> platesAggregated(Collection<Plate> collection, List<Double> list) {
     ...
     */
    public Map<Plate, List<List<Double>>> platesAggregated(Plate[] array, List<Double> list) {
    ...
    public List<List<Double>> platesAggregated(
            Plate plate, int begin, int length, List<Double> list) {
    ...
    public Map<Plate, List<List<Double>>> platesAggregated(
            Collection<Plate> collection, int begin, int length, List<Double> list) {
     ...
     */
    public Map<Plate, List<List<Double>>> platesAggregated(
            Plate[] array, int begin, int length, List<Double> list) {
     ...
     * @return                     map of wells and results
     */
    public Map<Well, List<List<Double>>> set(WellSet set, List<Double> list) {
     ...
     * @return                     map of wells and results
     */
    public Map<Well, List<List<Double>>> set(WellSet set, int begin, int length, List<Double> list) {
     ...
     * @return                     the aggregated result
     */
    public List<List<Double>> setsAggregated(WellSet set, List<Double> list) {
     ...
     */
    public Map<WellSet, List<List<Double>>> setsAggregated(Collection<WellSet> collection, List<Double> list) {
     ...
     * @return                       map of well sets and aggregated results
     */
    public Map<WellSet, List<List<Double>>> setsAggregated(WellSet[] array, List<Double> list) {
    ...
    public List<List<Double>> setsAggregated(
            WellSet set, int begin, int length, List<Double> list) {
    ...
    public Map<WellSet, List<List<Double>>> setsAggregated(
            Collection<WellSet> collection, int begin, int length, List<Double> list) {
     ...
     */
    public Map<WellSet, List<List<Double>>> setsAggregated(
            WellSet[] array, int begin, int length, List<Double> list) {
     ...
     * @return                    the result
     */
    public List<List<Double>> well(Well well, List<Double> list) {
     ...
     * @return                    the result
     */
    public List<List<Double>> well(Well well, int begin, int length, List<Double> list) {
        Preconditions.checkNotNull(well, "The well cannot be null.");
