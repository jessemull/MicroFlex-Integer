...
import com.github.jessemull.microflexinteger.math.Compliment;
...
public class ComplimentTest {
	...
	private static Compliment compliment = new Compliment();
	...
	public void testConstructor() {
		Compliment test = new Compliment();
		assertNotNull(test);
	}
    ...
    public void testPlates() {
        ...
        for(Plate[] plates : arrays) {
			...
			for(Plate plate : plates) {
				...
				Plate returnedPlate = compliment.plates(plate);
    ...
    public void testPlatesIndices() {
    	...
    	for(Plate[] plates : arrays) {
			...
			for(Plate plate : plates) {
				...
				Plate resultPlate = new Plate(plate.rows(), plate.columns(), result);
				Plate returnedPlate = compliment.plates(plate, begin, end - begin);
    ...
    public void testSets() {
        ...
        for(Plate[] plates : arrays) {
			...
			for(Plate plate : plates) {
				...
				WellSet result = new WellSet();
				WellSet returned = compliment.sets(plate.dataSet());
    ...
    public void testSetsIndices() {
        ...
        for(Plate[] plates : arrays) {
			...
			for(Plate plate : plates) {
				...
				WellSet result = new WellSet();
				WellSet returned = compliment.sets(plate.dataSet(), begin, end - begin);
    ...
    public void testStacks() {
        ...
        for(Stack stack : stacks) {
			...
			Stack returnedStack = compliment.stacks(stack);
    ...
    public void testStacksIndices() {
    	...
    	for(Stack stack : stacks) {
			...
			Stack returnedStack = compliment.stacks(stack, begin, end - begin);
