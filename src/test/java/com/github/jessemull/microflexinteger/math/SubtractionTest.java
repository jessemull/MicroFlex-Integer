...
import com.github.jessemull.microflexinteger.math.Subtraction;
...
public class SubtractionTest {
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = subtraction.plates(plate1, randomInt);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.sets(set, randomInt);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacks(stack1, randomInt);
