...
import com.github.jessemull.microflexinteger.math.Division;
...
public class DivisionTest {
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.plates(plate1, plate2);
    		Plate returnedPlateUneven = division.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.plates(plate1, plate2, begin, end - begin);
    		Plate returnedPlateUneven = division.plates(plate1, plateUneven, begin, end - begin);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.platesStrict(plate1, plate2);
    		Plate returnedPlateUneven = division.platesStrict(plate1, plateUneven);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.platesStrict(plate1, plate2, begin, end - begin);
    		Plate returnedPlateUneven = division.platesStrict(plate1, plateUneven, begin, end - begin);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.plates(plate1, randomInt);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returned = division.plates(plate1, array);
    		Plate returnedUneven = division.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.plates(plate1, array, begin, end - begin);
    		Plate returnedUneven = division.plates(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.plates(plate1, inputList);
    		Plate returnedUneven = division.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate returned = division.plates(plate1, inputList, begin, end - begin);
    		Plate returnedUneven = division.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.platesStrict(plate1, array);
    		Plate returnedUneven = division.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.platesStrict(plate1, array, begin, end - begin);
    		Plate returnedUneven = division.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.platesStrict(plate1, inputList);
    		Plate returnedUneven = division.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate returned = division.platesStrict(plate1, inputList, begin, end - begin);
    		Plate returnedUneven = division.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, false);
    		WellSet returned = division.sets(set1, set2);
    		WellSet returnedUneven = division.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSet returned = division.sets(set1, set2, begin, end - begin);
    		WellSet returnedUneven = division.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, true);
    		WellSet returned = division.setsStrict(set1, set2);
    		WellSet returnedUneven = division.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSet returned = division.setsStrict(set1, set2, begin, end - begin);
    		WellSet returnedUneven = division.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set, randomInt);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set1, array);
    		WellSet returnedUneven = division.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set1, array, begin, end - begin);
    		WellSet returnedUneven = division.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set1, inputList);
    		WellSet returnedUneven = division.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set1, inputList, begin, end - begin);
    		WellSet returnedUneven = division.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.setsStrict(set1, array);
    		WellSet returnedUneven = division.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.setsStrict(set1, array, begin, end - begin);
    		WellSet returnedUneven = division.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.setsStrict(set1, inputList);
    		WellSet returnedUneven = division.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.setsStrict(set1, inputList, begin, end - begin);
    		WellSet returnedUneven = division.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, stack2);
	    	Stack returnedUneven = division.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, stack2, begin, end - begin);
	    	Stack returnedUneven = division.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, stack2);
	    	Stack returnedUneven = division.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, stack2, begin, end - begin);
	    	Stack returnedUneven = division.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, randomInt);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, array);
	    	Stack returnedUneven = division.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, array, begin, end - begin);
	    	Stack returnedUneven = division.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, inputList);
	    	Stack returnedUneven = division.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, inputList, begin, end - begin);
	    	Stack returnedUneven = division.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, array);
	    	Stack returnedUneven = division.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, array, begin, end - begin);
	    	Stack returnedUneven = division.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, inputList);
	    	Stack returnedUneven = division.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, inputList, begin, end - begin);
	    	Stack returnedUneven = division.stacksStrict(stack1, inputListUneven, begin, end - begin);
