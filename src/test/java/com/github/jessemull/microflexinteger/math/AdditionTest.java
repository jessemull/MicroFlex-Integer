...
import com.github.jessemull.microflexinteger.math.Addition;
...
public class AdditionTest {
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = addition.plates(plate1, randomInt);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.sets(set, randomInt);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacks(stack1, randomInt);
