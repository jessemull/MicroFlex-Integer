...
import com.github.jessemull.microflexinteger.math.Multiplication;
...
public class MultiplicationTest {
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = multiplication.plates(plate1, randomInt);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = multiplication.sets(set, randomInt);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = multiplication.stacks(stack1, randomInt);
