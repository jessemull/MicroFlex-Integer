...
public class PlateReaderWellsTest {
	...
	private static Integer minValue = new Integer(0);                         // Minimum int value for wells
	private static Integer maxValue = new Integer(10);                        // Maximum int value for wells
	...
	private static List<Map<Well, Double>> maps = new ArrayList<Map<Well, Double>>();
	...
	public static void setUp() {
		...
		for(int j = 0; j < array.length; j++) {
			...
			labelList.add(label);
			array[j] = plate;
			maps.add((TreeMap<Well, Double>) mean.plate(plate));
		}
