...
public class SumOfSquaresTest {
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = sum.platesAggregated(collection);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = sum.platesAggregated(array);
    	Map<Plate, Double> aggregatedResultMap = new TreeMap<Plate, Double>();
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = sum.platesAggregated(arrayIndices, begin, end - begin);
    	Map<Plate, Double> aggregatedResultMap = new TreeMap<Plate, Double>();
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = sum.set(plate.dataSet(), begin, end - begin);
