...
public class PopulationVarianceTest {
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = variance.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = variance.setsAggregated(setArray);
    	Map<WellSet, Double> aggregatedResultMap = new TreeMap<WellSet, Double>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = variance.setsAggregated(collection, begin, end - begin);
    	Map<WellSet, Double> aggregatedResultMap = new TreeMap<WellSet, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = variance.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSet, Double> aggregatedResultMap = new TreeMap<WellSet, Double>();
