...
import com.github.jessemull.microflexinteger.stat.Kurtosis;
...
public class KurtosisTest {
    ...
    public void testPlate() {
		...
		for(Plate plate : array) {
    		...
    		Map<Well, Double> returnedMap = kurtosis.plate(plate);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = kurtosis.platesAggregated(collection);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = kurtosis.platesAggregated(array);
    	Map<Plate, Double> aggregatedResultMap = new TreeMap<Plate, Double>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = kurtosis.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = kurtosis.platesAggregated(arrayIndices, begin, end - begin);
    	Map<Plate, Double> aggregatedResultMap = new TreeMap<Plate, Double>();
    ...
    public void testSet() {
    	...
    	for(Plate plate : array) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = kurtosis.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = kurtosis.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = kurtosis.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = kurtosis.setsAggregated(setArray);
    	Map<WellSet, Double> aggregatedResultMap = new TreeMap<WellSet, Double>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = kurtosis.setsAggregated(collection, begin, end - begin);
    	Map<WellSet, Double> aggregatedResultMap = new TreeMap<WellSet, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = kurtosis.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSet, Double> aggregatedResultMap = new TreeMap<WellSet, Double>();
