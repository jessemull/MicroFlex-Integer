...
import com.github.jessemull.microflexinteger.stat.Min;
...
public class MinTest {
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = min.platesAggregated(collection);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = min.platesAggregated(array);
    	Map<Plate, Double> aggregatedResultMap = new TreeMap<Plate, Double>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = min.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = min.platesAggregated(arrayIndices, begin, end - begin);
    	Map<Plate, Double> aggregatedResultMap = new TreeMap<Plate, Double>();
    ...
    public void testSet() {
    	...
    	for(Plate plate : array) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = min.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = min.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = min.setsAggregated(collection);
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = min.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSet, Double> aggregatedResultMap = new TreeMap<WellSet, Double>();
