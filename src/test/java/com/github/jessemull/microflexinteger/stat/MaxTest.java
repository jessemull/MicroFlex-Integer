...
import com.github.jessemull.microflexinteger.stat.Max;
...
public class MaxTest {
    ...
    public void testPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = max.plate(plate, begin, end - begin);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = max.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, Double> aggregatedReturnedMap = max.platesAggregated(arrayIndices, begin, end - begin);
    	Map<Plate, Double> aggregatedResultMap = new TreeMap<Plate, Double>();
    ...
    public void testSet() {
    	...
    	for(Plate plate : array) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = max.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, Double> resultMap = new TreeMap<Well, Double>();
    		Map<Well, Double> returnedMap = max.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = max.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSet, Double> aggregatedReturnedMap = max.setsAggregated(setArray);
    	Map<WellSet, Double> aggregatedResultMap = new TreeMap<WellSet, Double>();
